...
<body>
    <h1 align='center' style="margin: 15px; color:seagreen;font-weight: bold;font-family:'Times New Roman', Times, serif">SREE COURIER SERVICE</h1>
    <hr />
    <P align='center' style="font-weight: bold;color:black;font-family:'Times New Roman', Times, serif">The World’s Speediest Courier Service</P>
    <div>
